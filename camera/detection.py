...
class Detection(BaseCamera):
    ...
    def __init__(self, source):
        ...
        self.net = cv2.dnn.readNetFromCaffe("D:\Windows\Downloads\codeathonBackend\camera\\faceData\deploy.prototxt", "D:\Windows\Downloads\codeathonBackend\camera\\faceData\\res10_300x300_ssd_iter_140000.caffemodel")
        self.maskNet = cv2.dnn.readNetFromCaffe("D:\Windows\Downloads\codeathonBackend\camera\maskData\deploy.prototxt", "D:\Windows\Downloads\codeathonBackend\camera\maskData\\face_mask.caffemodel")
